...
<s:iterator value="dataList">
    <div class="newsList dataItem">
        <div class="lis1" onclick="window.location.href='news_newDrugIntroductDetail.html?params.id=<s:property value="id"/>';">
            <img src='<s:property value="@com.jiuyi.qujiuyi.common.SysCfg@getString('server.file.url')"/><s:property value="icon"/>' alt="img">
        </div>
        <div class="lis2">
            <ul class="lisUl">
                <li>
                    <a href='news_newDrugIntroductDetail.html?params.id=<s:property value="id"/>' class="newsTitle">
                        <s:property value="title"/>
                    </a>
                </li>
                <li class="author">
                    <span class="nameTime_left"><s:property value="@com.jiuyi.qujiuyi.common.Util@getValueByKeyFromJson(addition, 'vender')"/>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="times">
        ...
        <span class="tipsName">适应症：</span>
        <ul class="tipps">
            <li>平喘止咳、清肺养肾</li>
        </ul>
    </div>
</s:iterator>
<form action="news_newDrugIntroductItem.html">
