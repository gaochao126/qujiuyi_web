...
<html>
            ...
            <div class="mainCont">
                ...
                <div class="leftCon">
	                ...
	                <div class="hotNews" id="hotNews">
                        <s:iterator value="hotNews" status="status">
    	                    <div class="hotNewsList" onclick="window.location.href='news_caseAnalysisDetail.html?params.id=<s:property value="id"/>';">
    	                        <span class="case_Index">
    	                            <p class="Case_num"><s:property value="#status.index + 1"/></p>
    	                            <p class="case_Index_p" title='<s:property value="title"/>'><s:property value="title"/></p>
    	                        </span>
    	                    </div>
                        </s:iterator>
	                </div>
	            ...
	            <div class="rightCon">
                    ...
                    <div id="newsList" class="dataList">
                        <jsp:include page="/pages/news/caseAnalysisItem.jsp" flush="true"/>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(".newsNavMod a").click(function(){
            ...
            $.ajax({
                type : "GET",
                url : "news_caseAnalysisItem.html",
                data : {
